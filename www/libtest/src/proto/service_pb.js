...
goog.exportSymbol('proto.cash.z.wallet.sdk.rpc.PriceRequest', null, global);
goog.exportSymbol('proto.cash.z.wallet.sdk.rpc.PriceResponse', null, global);
 ...
 * @constructor
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.cash.z.wallet.sdk.rpc.PriceRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.cash.z.wallet.sdk.rpc.PriceRequest.displayName = 'proto.cash.z.wallet.sdk.rpc.PriceRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.cash.z.wallet.sdk.rpc.PriceResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.cash.z.wallet.sdk.rpc.PriceResponse.displayName = 'proto.cash.z.wallet.sdk.rpc.PriceResponse';
}
...
proto.cash.z.wallet.sdk.rpc.TreeState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tree: jspb.Message.getFieldWithDefault(msg, 5, "")
  };
...
/**
 * optional string tree = 5;
 * @return {string}
 */
proto.cash.z.wallet.sdk.rpc.TreeState.prototype.getTree = function() {
 ...
 * @return {!proto.cash.z.wallet.sdk.rpc.TreeState} returns this
 */
proto.cash.z.wallet.sdk.rpc.TreeState.prototype.setTree = function(value) {
 ...
 * @return {!Object}
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.cash.z.wallet.sdk.rpc.PriceRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.cash.z.wallet.sdk.rpc.PriceRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceRequest}
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.cash.z.wallet.sdk.rpc.PriceRequest;
  return proto.cash.z.wallet.sdk.rpc.PriceRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.cash.z.wallet.sdk.rpc.PriceRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceRequest}
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.cash.z.wallet.sdk.rpc.PriceRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.cash.z.wallet.sdk.rpc.PriceRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.prototype.getTimestamp = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceRequest} returns this
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.prototype.setTimestamp = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.prototype.getCurrency = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceRequest} returns this
 */
proto.cash.z.wallet.sdk.rpc.PriceRequest.prototype.setCurrency = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.cash.z.wallet.sdk.rpc.PriceResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.cash.z.wallet.sdk.rpc.PriceResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    timestamp: jspb.Message.getFieldWithDefault(msg, 1, 0),
    currency: jspb.Message.getFieldWithDefault(msg, 2, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceResponse}
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.cash.z.wallet.sdk.rpc.PriceResponse;
  return proto.cash.z.wallet.sdk.rpc.PriceResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.cash.z.wallet.sdk.rpc.PriceResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceResponse}
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.cash.z.wallet.sdk.rpc.PriceResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.cash.z.wallet.sdk.rpc.PriceResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTimestamp();
  if (f !== 0) {
    writer.writeInt64(
 ...
 * @return {number}
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.getTimestamp = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceResponse} returns this
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.setTimestamp = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.getCurrency = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceResponse} returns this
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.setCurrency = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.getPrice = function() {
 ...
 * @return {!proto.cash.z.wallet.sdk.rpc.PriceResponse} returns this
 */
proto.cash.z.wallet.sdk.rpc.PriceResponse.prototype.setPrice = function(value) {
